    ...
    <el-card class="box-card">
      ...
      <div slot="header" class="clearfix">
        ...
        <div class="search">
          ...
          <el-input v-model="name_contains" placeholder="请输入内容" class="input-with-select"
      ...
      <div>
        ...
        <!-- 分页组件 -->
        <el-pagination background :pager-count="5" layout="prev, pager, next" :total="total" :page-size="pageSize"
          :current-page.sync="currentPage" @current-change="loadPropertiesList" />

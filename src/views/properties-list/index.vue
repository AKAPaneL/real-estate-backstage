<template>
  <div class="clients-contains">
    <el-card class="box-card">
      ...
      <div>
        <!-- 表格 -->
        <el-table :data="clientsList" border style="width: 100%">
          ...
          <el-table-column prop="wechat" label="地址" />
          <el-table-column prop="email" label="分类" />
          <el-table-column prop="agent.name" label="经纪人" />
          <el-table-column prop="phone" label="价格" />
